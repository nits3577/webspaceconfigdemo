...
//add a progressbar
    ...
    if ($f === $this->steps) {
        ...
        if (empty($this->visforms->displaysummarypage)) {
            echo LayoutHelper::render('visforms.footers.btdefault.nosummary', array('form' => $this->visforms, 'nbFields' => $this->nbFields, 'hasRequired' => $this->required));
        } //with summary page
        else {
            echo LayoutHelper::render('visforms.footers.btdefault.withsummary', array('form' => $this->visforms, 'nbFields' => $this->nbFields, 'hasRequired' => $this->required, 'summarypageid' => $this->visforms->parentFormId));
        }
    }
    echo '</fieldset>';
    } ?>
