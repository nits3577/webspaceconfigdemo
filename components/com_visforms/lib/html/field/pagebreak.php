...
class VisformsHtmlPagebreak extends VisformsHtml
{
	...
	// field type specific manipulations for bootstrap 2 and 3 layouts
    ...
    public function setControlBt5HtmlClasses($field) {
        $field->attribute_class = (!empty($this->field->fieldCSSclass)) ? ' btn next_btn me-2 col-auto' : ' btn next_btn btn-info me-2 col-auto';
        return $field;
    }
