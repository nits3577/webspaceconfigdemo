...
class VisformsHtmlControlBt5Select extends VisformsHtmlControl
{

	public function getControlHtml() {
		return LayoutHelper::render('visforms.bt5.select.control', array('field' => $this->field->getField()), null, array('component' => 'com_visforms'));
	}
