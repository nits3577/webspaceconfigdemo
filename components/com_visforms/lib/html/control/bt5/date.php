...
class VisformsHtmlControlBt5Date extends VisformsHtmlControl
{
	public function getControlHtml() {
		return LayoutHelper::render('visforms.bt5.date.control', array('field' => $this->field->getField()), null, array('component' => 'com_visforms'));
	}
