...
if (!empty($displayData)) : 
    if (isset($displayData['form'])) :
        ...
        if (isset($form->captcha))
        {
            ...
            $html[] = (!(isset($form->showcaptchalabel)) || ($form->showcaptchalabel == 0)) ? '<label id="captcha-lbl" for="recaptcha_response_field">' . $captchalabel . '</label>' : '<span class ="asterix-ancor"></span>';
            if ($clear)
            {
