	...
	Plugin.prototype = {
		init: function () {
			...
			self.filterButton.click(function(e) {
				if (this.classList.contains('visToolTip')) {
					tooltip = bootstrap.Tooltip.getInstance(this);
					if (tooltip !== 'undefined' && tooltip !== null) {
						tooltip.hide();
					}
					else {
						console.log('Warning: There is a Javascript incompatiblity on your website. Please make sure, that jQuery and Bootstrap Javascript are only included once, using Joomla core functions')
					}
				}
				self.toggleFilters();
				e.stopPropagation();
